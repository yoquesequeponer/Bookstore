...
<head>
  ...
  <!-- Favicons -->
  <link href="<?=ROOT_PATH?>public/img/favicon.png" rel="icon">
  <link href="<?=ROOT_PATH?>public/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <?php if(isset($_SESSION['is_logged_in'])) : ?>
         <strong style="color: white;">Welcome <?php echo $_SESSION['user_data']['name']; ?></strong>
         <a href="<?=ROOT_PATH?>users/logout">Logout</a>

        <?php else : ?>
        <a href="<?=ROOT_PATH?>users/register">Register</a>
        <a href="<?=ROOT_PATH?>users/login">Login</a>
      <?php endif; ?>
  ...
  <!-- Vendor JS Files -->
  <script src="<?=ROOT_PATH?>public/vendor/aos/aos.js"></script>
  <script src="<?=ROOT_PATH?>public/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="<?=ROOT_PATH?>public/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="<?=ROOT_PATH?>public/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="<?=ROOT_PATH?>public/vendor/php-email-form/validate.js"></script>
  <script src="<?=ROOT_PATH?>public/vendor/swiper/swiper-bundle.min.js"></script>
